...
bool LeafSystem::createComputePipeline(SystemLifecycleHelper::PipelineHandles& handles) {
    ...
    auto pushConstantRange = vk::PushConstantRange{}
        ...
        .setOffset(0)
        .setSize(sizeof(LeafPushConstants));
...
bool LeafSystem::createGraphicsPipeline(SystemLifecycleHelper::PipelineHandles& handles) {
    ...
    auto rasterizer = vk::PipelineRasterizationStateCreateInfo{}
        ...
        .setLineWidth(1.0f)
        .setCullMode(vk::CullModeFlagBits::eNone)  // No culling for leaves (visible from both sides)
    ...
    auto depthStencil = vk::PipelineDepthStencilStateCreateInfo{}
        ...
        .setDepthWriteEnable(true)  // Write depth for proper sorting
