...
/**
 * SceneMaterial - A material with its associated meshes, textures, and instances
 *
 * This represents a single material in the scene, combining:
 * - Material properties (roughness, metallic, shadow casting)
 * - Textures (diffuse, normal)
 * - Mesh variations that use this material
 * - Instances of those meshes in the scene
 *
 * Multiple SceneMaterials are collected in a SceneCollection.
 */
class SceneMaterial {
public:
    struct InitInfo {
